...
Please review the Services (job queues, cache servers, search engines, etc.)
and Deployment instructions


**************************
Review the example where REST principles allow us to model a subtler problem, “following users”, in a natural and convenient way.
